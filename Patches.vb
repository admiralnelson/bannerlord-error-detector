...
Public Module Patches
    ...
    Public Sub InitPatch()
        ...
        If CatchNative2Managed Then PatchNative2Managed()
    ...
    Private Sub ExceptionTest()
        ...
        Dim Mission_EndMission = autoGeneratedType.GetMethods(BindingFlags.NonPublic Or BindingFlags.Static).Where(Function(x) x.Name.Contains("Mission_OnSceneCreated")).LastOrDefault()
        Dim crashTestMethod = AccessTools.Method(GetType(AutoGeneratedExceptionFilter), "Prefix")
        harmony_.Patch(Mission_EndMission, New HarmonyMethod(crashTestMethod))

    End Sub
    Private Sub PatchNative2Managed()
        Dim autogenerated = GetAssemblyByDll("TaleWorlds.MountAndBlade.AutoGenerated.dll")
        Dim autoGeneratedType = autogenerated.GetTypes().Where(Function(x) x.Name.EndsWith("CallbacksGenerated")).FirstOrDefault()
